...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Veterans Treatment Court Mentor Nexus";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Veteran Case Record";
process.env.TABLE_NAME = process.env.TABLE_NAME || "veteran_case_record_records";
'use strict';
